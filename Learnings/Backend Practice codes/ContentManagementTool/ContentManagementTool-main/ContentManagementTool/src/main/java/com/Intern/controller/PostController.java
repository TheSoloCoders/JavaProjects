...
import com.Intern.config.AppConstants;
...
public class PostController {
	...
	@Value("${project.image}")//image path for uploading
	private String path;
	...
	//save user
		...
		public ResponseEntity<PostDto> uploadPostImage(@RequestParam("image") MultipartFile image,
			...
			PostDto updatePost = this.postService.updatepost(postDto, postId);//update in database
			return new ResponseEntity<PostDto>(updatePost, HttpStatus.OK);
