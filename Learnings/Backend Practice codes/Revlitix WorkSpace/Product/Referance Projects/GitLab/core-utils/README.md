...
```
cd existing_repo
git remote add origin https://gitlab.ops.revlitix.com/revlitix/backend/packages/core-utils.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ops.revlitix.com/revlitix/backend/packages/core-utils/-/settings/integrations)
...
- [ ] [Set up  private environments](https://docs.gitlab.com/ee/ci/environments/private_environments.html)
